      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card-bg border border-slate-800 rounded-2xl p-6 sm:p-10">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-red-400">NO REFUND UNDER ANY CIRCUMSTANCES.</strong> Once payment has been received, no refunds will be issued under any circumstances, including but not limited to:
            </p>
            <ul className="text-slate-300 leading-relaxed list-disc pl-6 mt-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="text-slate-300 leading-relaxed list-disc pl-6 space-y-2 mb-4">
              <li><strong className="text-slate-50">Basic Package:</strong> 1 month free support</li>
              <li><strong className="text-slate-50">Standard Package:</strong> 3 months free support</li>
              <li><strong className="text-slate-50">Premium Package:</strong> 6 months free support</li>
            </ul>
            <p className="text-slate-300 leading-relaxed mb-3">
              <strong className="text-slate-50">What is included in free support:</strong>
            </p>
            <ul className="text-slate-300 leading-relaxed list-disc pl-6 space-y-2 mb-4">
            ...
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-slate-50">What is NOT included in free support:</strong>
            </p>
            <ul className="text-slate-300 leading-relaxed list-disc pl-6 mt-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-primary">Full ownership of all intellectual property rights transfers to the client only after complete payment has been received.</strong> Until such time as full payment is made, all intellectual property rights shall remain with Qentara Technologies.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              These Terms shall be governed by and construed in accordance with the laws of <strong className="text-slate-50">India</strong>. Any disputes arising out of or relating to these Terms or our services shall be subject to the exclusive jurisdiction of the courts located in <strong className="text-slate-50">India</strong>.
            </p>
            <p className="text-slate-300 leading-relaxed">
